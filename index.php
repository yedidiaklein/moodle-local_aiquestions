...
echo $OUTPUT->header();
echo "<p>" . get_string('pluginname', 'local_aiquestions') . "</p>";
echo "<p>" . get_string('pluginname_desc', 'local_aiquestions') . "</p>";
echo "<p>" . get_string('pluginname_help', 'local_aiquestions') . "</p>";
echo $OUTPUT->footer();
