...
$string['contentsource_help'] = 'Choose how you want to provide the content for question generation: enter text directly, select a file from the course, or load content from a URL.';
$string['contenturl'] = 'Content URL';
$string['contenturl_help'] = 'Enter a URL to a webpage or document. The content will be extracted and used to generate questions.';
...
$string['file'] = 'File to use';
$string['file_help'] = 'Select a file from the course to extract the text from. If you select a file, it will override other content sources.';
...
$string['generationtriesfull'] = 'Number of tries sent to OpenAI: <b>{$a->tries}</b> out of <b>{$a->numoftries}</b>';
...
$string['selectsource'] = 'Select the source for generating questions:';
...
$string['sourcefile'] = 'Use file from course';
$string['sourcetext'] = 'Enter text directly';
$string['sourceurl'] = 'Load content from URL';
$string['story'] = 'Topic';
