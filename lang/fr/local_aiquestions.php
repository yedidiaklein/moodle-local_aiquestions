...
$string['contentsource'] = 'Source du Contenu';
$string['contentsource_help'] = 'Choisissez comment vous voulez fournir le contenu pour la génération de questions: entrer le texte directement, sélectionner un fichier du cours, ou charger le contenu depuis une URL.';
$string['contenturl'] = 'URL du Contenu';
$string['contenturl_help'] = 'Entrez une URL vers une page web ou un document. Le contenu sera extrait et utilisé pour générer des questions.';
...
$string['generationtriesfull'] = 'Nombre de tentatives envoyées à OpenAI : <b>{$a->tries}</b> sur <b>{$a->numoftries}</b>';
$string['file'] = 'Fichier à utiliser';
$string['file_help'] = 'Sélectionnez un fichier du cours pour extraire le texte. Si vous sélectionnez un fichier, il remplacera les autres sources de contenu.';
$string['gotoquestionbank'] = 'Accéder à la banque de questions';
$string['invalidurl'] = 'Veuillez entrer une URL valide';
...
$string['selectsource'] = 'Sélectionnez la source pour générer les questions:';
$string['sourcefile'] = 'Utiliser un fichier du cours';
$string['sourcetext'] = 'Entrer le texte directement';
$string['sourceurl'] = 'Charger le contenu depuis une URL';
